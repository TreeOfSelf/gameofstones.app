              ...
              <?php
                ...
                if ($cityRumors['checktime'] > 0)
                {
                  ...
                  else if ($minFromBreak < 53280) // 888 hours after first seal break LB ends
                  {
					...
					//WE ARE IN PHASE ONE
					if($hoursFromBreak < $p2Start){
						echo "<b>Phase two begins in: ".($p2Start-$hoursFromBreak)." hours."."</b><br/><br/>" ;
					}else if($hoursFromBreak < $p3Start){
						echo "<b>Phase three begins in: ".($p3Start-$hoursFromBreak)." hours."."</b><br/><br/>" ;
					}else {
						echo "<b>Last battle ends in: ".($LBEnd-$hoursFromBreak)." hours."."</b><br/><br/>" ;
					}
                  }
                  else
                  {
